...
class StickerBSFragment : BottomSheetDialogFragment() {
    ...
    private var stickerPathList: List<String> = DEFAULT_STICKERS

    fun setStickerListener(stickerListener: StickerListener?) {
        mStickerListener = stickerListener
    }

    fun setStickers(stickers: List<String>) {
        if (stickers.isNotEmpty()) {
            stickerPathList = stickers
        }
    }
    ...
    override fun setupDialog(dialog: Dialog, style: Int) {
        ...
        val contentView = View.inflate(context, R.layout.pe_fragment_bottom_sticker_emoji_dialog, null)
    ...
    inner class StickerAdapter : RecyclerView.Adapter<StickerAdapter.ViewHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view = LayoutInflater.from(parent.context).inflate(R.layout.pe_row_sticker, parent, false)
    ...
    companion object {
        ...
        private val DEFAULT_STICKERS = listOf(
